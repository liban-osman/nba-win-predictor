...
def head_to_head(p1, p2):
    ...
    for x in range(range1):
        ...
        if len(player1_teams[player1_teams.SEASON == season]) > 0:
            ...
            teams1.append(1610612745) ##lol rajon rando
    ...
    for x in range(range2):
        ...
        if len(player2_teams[player2_teams.SEASON == season]) > 0:
            ...
            teams2.append(1610612745) ##randooo
...
while True:
    ...
    first_team = input("Enter First Team: ")
    
    second_team = input("Enter Second Team: ")

    if not(first_team in Teams.Teams) or not(second_team in Teams.Teams):
        break

    else:
        new_team1 = Teams.Teams[first_team]
        new_team2 = Teams.Teams[second_team]
        ...
        team1_ratio = team1_ratio / 25
        print("Team1 Wins: " + str(team1_wins))
        print("Team2 Wins: " + str(team1_losses))
        team1_win_ratio = team1_wins / (team1_wins + team1_losses)
        print("Team1 Weighted Win Ratio: " + str(team1_win_ratio))
        print("Another Team1 Win Ratio: " + str(team1_ratio))
